...
<html>
<head>
	<title>Libreria-Usuario Registrado!</title>
...
<div class="container">
    <div class="row">
        ...
        <div class="col m5">
            <div class="row">
             <p id="texto-azul"><h2 class="center-align">Usuario Registrado</h2></p><br><br>
             <p class="grey-text text-lighten-4"><h5>Ya eres usuario Registrado de esta libreria virtual, ahora podras apartar y comprar libros diguitales o fisicos en este sitio desde la comodidad de tu casa (a las chicas de verdad les gusta el pollo frito) </h5></p><br><br>
             <p><h5>Para volver al inicio da click <a href="/">aqui</a></h5></p>
            </div>
        </div>
    </div>
</div>
